...
```
Evaluemos ahora como es la dependencia entre la temperatura y la demanda de energía. Se tiene la idea que se consume más electricidad en los días fríos debido a la calefacción y en los días calurosos debido al aire acondicionado. Veamos una gráfica entre entre la demanda diaria contra la temperatura máxima diaria, recordemos que las mediciones son cada media hora.
