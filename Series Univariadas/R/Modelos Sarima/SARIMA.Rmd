...
* $I_{2t}^{(h)}:$ Variable que que toma el valor de 1 cuando febrero tiene un día más por ser un año bisiesto.
...
modelo_accidentes_xreg = Arima(accidentes_ts, c(2, 1, 0),seasonal = list(order = c(1, 1, 2), period = 12),lambda = 0,xreg = efectos)
