...
tsibble_lAirPass|>mutate(diff_lAirPass=difference(value,lag=1,differences = 1))|>
  autoplot(.vars =diff_lAirPass ) + labs(subtitle = "Cambios en escala logarítmica de los pasajeros")

tsibble_lAirPass<-tsibble_lAirPass|>mutate(diff_lAirPass=difference(value,lag=1,differences = 1))
