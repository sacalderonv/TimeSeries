...
Otra forma de introducir la estacionalidad de forma estocástica es permitir que sea cambiante en el tiempo sin ningún valor fijo medio. En este caso la estacionalidad puede proponerse que siga un proceso no estacionario por ejemplo que siga una caminata aleatoria: $$S_t^{(s)}=S_{t-s}^{(s)}+\nu_t$$ siendo $\nu_t$ es un proceso estacionario de media cero.
