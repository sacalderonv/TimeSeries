...
#####Arima Automático
modelo.automatico1=auto.arima(y+3,d=0,D=0,max.p=1,max.q=4,start.p=0, start.q=0,seasonal=FALSE,max.order=5,stationary=TRUE,ic="aicc",stepwise=FALSE,allowmean = TRUE)  ###Se propuso un modelo ARMA(1,4), aunque varios coeficientes no son significativo
modelo.automatico1
...
```{r arima automatico}
Arima_automatico_sercam=forecast::auto.arima(sercamrelint,d=0,D=0,max.p=4,max.q=4,start.p=0, start.q=0,seasonal=FALSE,max.order=8,stationary=TRUE,ic="bic",stepwise=FALSE,allowmean = TRUE) 
