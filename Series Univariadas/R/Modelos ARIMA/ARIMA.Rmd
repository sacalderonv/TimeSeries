...
fUnitRoots::adfTest(arimaej_raiz_unit,lags = 10,type='nc')  
fUnitRoots::adfTest(arimaej_raiz_unit,type='nc') 
####No hay presencia de Raíz Unitaria
tseries::adf.test(arimaej_raiz_unit,k=5)   ####Note que hay 
######
urca::ur.df(arimaej_raiz_unit,type="none")
summary(urca::ur.df(arimaej_raiz_unit,type="none"))
