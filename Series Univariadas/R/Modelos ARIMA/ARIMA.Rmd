...
fUnitRoots::adfTest(arimaej_raiz_unit,lags =3 ,type='nc')  
fUnitRoots::adfTest(arimaej_raiz_unit,type='nc') 
####No hay presencia de Raíz Unitaria
tseries::adf.test(arimaej_raiz_unit,k=3)   ####Note que hay 
######
prueba_df=ur.df(arimaej_raiz_unit,type="none",lags=4)
summary(prueba_df)
...
```{r Pasajeros2}
ar(log(AirPassengers)) ##Selecciona un modelo AR usando el crierio de Akaike  a la serie Aaa

adf.test(log(AirPassengers))
ar(log(AirPassengers))
adf.test(log(AirPassengers),k=13)
