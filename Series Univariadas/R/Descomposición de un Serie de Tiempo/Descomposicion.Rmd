...
### verval contiene los verdaderos valores de la serie con los que se compararán los pronósticos
...
HWAP_train$beta
HWAP_train$gamma
###Observación: Note que que esos son las estimaciones de los parámetros de suavizamineto. Se puede también hacer una grilla de valores para explorar si hay unos valores mejores.
...
Haremos rolling unsando la función "ro()" programada en R del paquete
